...
<!-- This content is auto-generated from the repoverlay CLI help.
     Regenerate with: cargo run -- --markdown-help > website/src/content/docs/cli-reference.md
     Then re-add the frontmatter above. -->
