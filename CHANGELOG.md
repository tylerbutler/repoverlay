...
- *(ci)* correct allow_dirty config in release-plz.toml
- *(ci)* use correct rust-toolchain action in release workflows
- *(ci)* use correct dtolnay/rust-toolchain action name
